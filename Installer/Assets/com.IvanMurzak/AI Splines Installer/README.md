...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.splines/package.json`
...
- 👉 **Delete** `Packages/com.ivanmurzak.unity.mcp.splines/Tests` folder
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.splines` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.splines` as well.
