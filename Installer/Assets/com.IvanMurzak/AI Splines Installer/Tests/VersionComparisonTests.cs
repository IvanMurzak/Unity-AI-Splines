...
using com.IvanMurzak.Unity.MCP.Splines.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.Splines.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.Splines.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.splines";
