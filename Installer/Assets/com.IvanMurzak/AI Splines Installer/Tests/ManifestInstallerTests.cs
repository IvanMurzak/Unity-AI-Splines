...
namespace com.IvanMurzak.Unity.MCP.Splines.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI Splines Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI Splines Installer/Tests/Files";
