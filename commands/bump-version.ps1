...
$VersionFiles = @(
    @{
        Path        = "Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/package.json"
        Pattern     = '"version":\s*"[\d\.]+"'
        Replace     = '"version": "{VERSION}"'
        Description = "Unity package version"
    },
    @{
        Path        = "Installer/Assets/com.IvanMurzak/AI Splines Installer/Installer.cs"
...
function Get-CurrentVersion {
    ...
    $packageJsonPath = "Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/package.json"
