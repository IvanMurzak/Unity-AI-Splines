...
#### 1️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.splines/package.json`
...
<details>
  ...
  - Update the files:
    - `Packages/com.ivanmurzak.unity.mcp.splines/Tests/Base/Package.Editor.Tests.asmdef`
    - `Packages/com.ivanmurzak.unity.mcp.splines/Tests/Base/Package.Tests.asmdef`
