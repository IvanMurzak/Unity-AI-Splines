...
├── Unity-Package/            # The package source — only `Packages/com.ivanmurzak.unity.mcp.splines/` ships
│   └── Assets/
...
> Anything outside `Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/` is NOT shipped to consumers.
...
- **Dependency:** `com.ivanmurzak.unity.mcp` v0.68.0 (declared in `Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/package.json`)
...
- **Editor tool** → put under `Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/Editor`
  - Works in Edit Mode and Play Mode in the Editor.
  - Has access to Editor APIs.
  - NOT shipped in game builds.
- **Runtime tool** → put under `Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/Runtime`
  - Works in Edit Mode and Play Mode in the Editor.
