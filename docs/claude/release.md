...
- Reads the current version from `Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/package.json`.
- Updates these files atomically:
  - `Unity-Package/Packages/com.ivanmurzak.unity.mcp.splines/package.json` — `"version": "X.Y.Z"`
